...
guide users down the sales funnel.`
    ...
    "market-research": {
        ...
        results: {
            itle: "Impact: How We Deliver Results",
            items: [
                {
    ...
    "e-commerce-optimization": {
        ...
        "advantage": {
            ...
            "approach": [
                `User-Centric Design: Redesign e-commerce platforms to improve navigation and usability.`,
                `AI-Powered Analytics: Track and analyze user behavior to refine marketing and sales strategies.`,
                `Backend Automation: Integrate AI tools for real-time inventory updates and automated order processing.`
            ]
        },
        "process": {
            "title": "What to Expect",
