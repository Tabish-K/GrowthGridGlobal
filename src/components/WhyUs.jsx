...
function WhyUs() {
    ...
    return (
        <div id="why-us" className="bg-white text-gray-800">
            {/* We are growth grid */}
            <div className="container relative mx-auto px-4 lg:px-36 py-8 lg:py-16">
                <div className="absolute -bottom-48 -left-48 w-[20rem] h-[20rem] bg-[#CC0012]/90 blur-3xl rounded-full"></div>
                    ...
                    <section className="bg-white">
                        ...
                        >
                            {/* <motion.div 
                                ...
                                className="h-[2px] bg-[#CC0000] mx-auto mb-16 flex"
                            /> */}


                            {/* Heading Section */}
                            <motion.div variants={itemVariants} className="text-center mb-16 flex flex-col md:flex-row w-full gap-12">
                                <div className="text-center lg:text-left space-y-4 flex flex-col items-center sm:items-start">
                                    <h1 className="text-4xl relative mb-8 md:text-6xl lg:text-7xl font-medium">
                                        We are <br />
                                        <span className="bg-gradient-to-r from-[#CC0012] to-[#CC0012]/40 bg-clip-text font-bold text-transparent">Growth Grid</span>
                                    </h1>
                                    <button className="relative flex items-center border-2 border-[#CC0012] px-4 py-2 sm:py-3 rounded-full w-[11rem] overflow-hidden h-[50px] sm:h-[55px]">
                                        <span className="text-base sm:text-lg relative z-10 text-gray-800 font-semibold">
                                            Learn More
                                        </span>
                                        <span className=" text-white absolute right-2 mb-2 w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-gradient-to-r from-red-300 via-red-500 to-red-700 rounded-full z-10 translate-y-1">
                                            <MoveRight/>
                                        </span>
                            ...
                            <div className="max-w-[40rem]">
                                <div className="text-gray-700 space-y-4 text-center lg:text-left">
                                    <p className="text-md sm:text-[22px] font-semibold text-black tracking-wide text-justify">
                                    ...
                                    <p className="text-md sm:text-[20px] tracking-wide text-justify">
                                    ...
                                    <p className="text-md sm:text-[20px] tracking-wide text-justify">
                                        Our <span className="text-[#CC0012] font-semibold">{`end-to-end support`}</span> guarantees a seamless journey from ideation and strategy to implementation and ongoing optimization.
                                    </p>
                                </div>

                                {/* Stats Grid */}
                                <div className="grid grid-cols-1 md:grid-cols-3 mt-12 text-start relative z-20">
                                    {stats.map((stat, index) => (
                                        <motion.div
                                            key={index}
                                            variants={itemVariants}
                                            className="text-start space-y-4 py-6 px-2"
                                        >
                                            <h2 className="bg-gradient-to-r from-[#CC0012] to-[#CC0012]/40 bg-clip-text text-transparent text-4xl lg:text-5xl font-semibold tracking-tight">
